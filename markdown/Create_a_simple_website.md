...
3. In your git repository (better to clone and work locally) *username.github.io*, make two folders, one titled `markdown` to store markdown files and another titled `html` to store html.
