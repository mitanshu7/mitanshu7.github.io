...
- [ ] Make my OnePlus Stylo 2 work with OnePlus 11r.

  - Stylo 2 is a pencil launced alongside OnePlus Pad 2, which i happen to own.
  - It would be a nice feature to have the pencil work with the phone I own, so I dont have to change the interface.
...
- [ ] Run [DuckDB](https://duckdb.org/) on [Kindle](https://en.wikipedia.org/wiki/Amazon_Kindle)
  ...
  - DuckDB is a powerful database which tries to be as portable as SQLite.
  - Have making it run on kindle and benchmark it would be cool.
