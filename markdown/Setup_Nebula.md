...
You can copy paste the auto-generated command on your [instances](console.cloud.google.com/compute/instances) page. Click on the down arrow near `SSH` under the `Connect` column and select `View gcloud command`.
