...
0. **NEEDED**: have a new user in sudo group with a password handy before doing anything here. It will be handy in troubleshooting via the `Cloud Shell` in case things go awry. (Which is how this whole tutorial was executed :)) 
